  ...
  private buildEnv(): Record<string, string> {
    const configOverride = JSON.stringify({
      ...
      perspectiveModels: this.config.perspectiveModels ?? {
        'henry-wu': this.config.models.interview[0],
        occam: this.config.models.interview[0],
        'heist-o-tron': this.config.models.interview[0],
        hickam: this.config.models.interview[0],
        kirk: this.config.models.interview[0],
      },
